(function(){
  ...
  function enhanceRecruitmentCard(){
    ...
    const frame=card.querySelector('.live-demo-preview');if(frame)frame.src='demo.html?id=recruitment&embed=1&v=20260908-agent-pages1';
    ...
    if(agentButton){agentButton.href='recruitment-agent-platform.html?v=20260908-agent-pages1';agentButton.textContent='AI Agents demo ↗';}
