(function(){
  ...
  function add(p){
    ...
    const previewHref=p.id==='monday-project-ops'?'monday-project-ops-demo-native-v8.html?embed=1&v=20260907-native-agent-widgets1':`demo.html?id=${p.id}&embed=1`;
  ...
  function enhanceMondayCard(){
    ...
    if(frame)frame.src='monday-project-ops-demo-native-v8.html?embed=1&v=20260907-native-agent-widgets1';
  }
  enhanceMondayCard();
