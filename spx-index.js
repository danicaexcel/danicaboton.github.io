(function(){
  ...
  if(copy) copy.textContent='A first-mile operations workspace preserving the client’s familiar daily logs and summaries while adding route progress, pooled pickup parcels, warehouse-trip handover + pay, attendance, closing-time risk, owner visibility, WhatsApp escalation, and screenshot OCR intake.';
  ...
  if(metrics) metrics.innerHTML='<div class="mini"><strong>5 min</strong><span>driver compliance monitoring cadence</span></div><div class="mini"><strong>$0.03</strong><span>per handed-over parcel pay basis</span></div>';
  const caseLink=card.querySelector('a[href*="case-study.html"],a[href*="spx-case-study.html"]');
  if(caseLink) caseLink.href='spx-case-study.html?v=20260903-spx-ops3';
  ...
  if(frame){
    ...
    frame.src='demo.html?id=ocr&embed=1&v=20260903-spx-ops3';
  }
})();