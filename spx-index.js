(function(){
  ...
  if(caseLink) caseLink.href='spx-case-study.html?v=20260906-spx-single1';
  ...
  if(frame){
    ...
    frame.src='demo.html?id=ocr&embed=1&v=20260906-spx-single1';
  }
  card.querySelectorAll('a[href*="demo.html?id=ocr"]').forEach(link=>{link.href='demo.html?id=ocr&v=20260906-spx-single1';});
})();