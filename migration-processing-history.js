(function () {
  ...
  const events = [
    ...
    ['2026-09-03 10:07:15','AUD-0007','COR-28-184','JHR-028','SRC-000184','Normalizer','PII normalization','Email, mobile, address, company, designation','In-memory transformation; log stores status only','PASS','EV-07 · DH-09'],
    ['2026-09-03 10:07:16','AUD-0008','COR-28-184','JHR-028','SRC-000184','Dedupe function','Duplicate search','Normalized email/mobile/resume filename','Search keys not emitted in audit output','NO_MATCH','EV-02 · DH-05'],
    ...
    ['2026-09-03 10:07:18','AUD-0013','COR-28-184','JHR-028','SRC-000184','Migration service','Resume reference write','Authorized Drive file reference','Reference retained; file content not duplicated in log','PASS','EV-08 · DH-03'],
    ...
    ['2026-09-03 10:07:22','AUD-0020','COR-28-186','JHR-028','SRC-000186','Dedupe function','Duplicate search','Normalized email/mobile/resume filename','Comparison performed without logging raw search values','MATCH','EV-02 · DH-05'],
    ['2026-09-03 10:07:23','AUD-0021','COR-28-186','JHR-028','SRC-000186','Migration service','Duplicate disposition','Source ref + destination match ref','No second destination record created','DUPLICATE','EV-03 · DH-07'],
