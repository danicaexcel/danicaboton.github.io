(() => {
  ...
  function hideRecruitmentAgentSurface(root=document){
    ...
    document.querySelectorAll('.project[data-id="recruitment"] .p01-dual-demo-note,#agent-extension').forEach(el=>el.remove());
    document.querySelectorAll('a[href="#agent-extension"]').forEach(el=>el.remove());
  }
