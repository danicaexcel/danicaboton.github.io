(() => {
  ...
  function refreshRecruitmentAgentLinks(root=document){const links=[];if(root.matches?.('a[href*="recruitment-agent-platform.html"]'))links.push(root);root.querySelectorAll?.('a[href*="recruitment-agent-platform.html"]').forEach(link=>links.push(link));links.forEach(link=>{link.href='recruitment-agent-platform.html?v=20260908-agent-sidebar1';});}
